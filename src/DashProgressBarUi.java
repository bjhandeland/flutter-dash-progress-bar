...
public class DashProgressBarUi extends BasicProgressBarUI {
    private static final float ONE_OVER_THREE = 1f / 3;
    private static final Color DASH_CYAN = new Color(0, 172, 184);
    private static final Color DASH_BLUE_LIGHT = new Color(0, 143, 212);
    private static final Color DASH_BLUE_DARK = new Color(0, 117, 187);

    @SuppressWarnings({"MethodOverridesStaticMethodOfSuperclass", "UnusedDeclaration"})
    public static ComponentUI createUI(JComponent c) {
        c.setBorder(JBUI.Borders.empty().asUIResource());
        return new DashProgressBarUi();
    }
    ...
    protected void paintIndeterminate(Graphics g2d, JComponent c) {
        ...
        LinearGradientPaint baseRainbowPaint = new LinearGradientPaint(0, JBUI.scale(2), 0, h - JBUI.scale(6),
                new float[]{ONE_OVER_THREE * 1, ONE_OVER_THREE * 2, ONE_OVER_THREE * 3},
                new Color[]{DASH_CYAN, DASH_BLUE_LIGHT, DASH_BLUE_DARK});
...
//        g.setPaint(baseRainbowPaint);
        ...
        Icon scaledIcon = velocity > 0 ? ((ScalableIcon) DashIcons.DASH_ICON) : ((ScalableIcon) DashIcons.RDASH_ICON) ;
//        if (velocity < 0) {
...
//        g2.setColor(progressBar.getForeground());
        ...
        DashIcons.DASH_ICON.paintIcon(progressBar, g2, amountFull - JBUI.scale(10), -JBUI.scale(6));
